...
var NotepadElementMenu = _wrapComponent('NotepadElementMenu')(function (_Component) {
  ...
  _createClass(NotepadElementMenu, [{
    ...
    value: function render() {
      ...
      }, _react3.default.createElement(_reactNative.View, { style: [_style.styles.noteTypePickerItem, { borderTopWidth: 0 }] }, _react3.default.createElement(_reactNative.Text, { style: _style.styles.defaultText }, 'Complete'))), _react3.default.createElement(_reactNative.TouchableNativeFeedback, {
        background: _reactNative.TouchableNativeFeedback.SelectableBackground(),
        onPress: function onPress() {
          _this2.props.editorActions.deleteNote(_this2.props.note);
        }
      }, _react3.default.createElement(_reactNative.View, { style: _style.styles.noteTypePickerItem }, _react3.default.createElement(_reactNative.Text, { style: _style.styles.defaultText }, 'Delete'))))))));
    }
  }]);
