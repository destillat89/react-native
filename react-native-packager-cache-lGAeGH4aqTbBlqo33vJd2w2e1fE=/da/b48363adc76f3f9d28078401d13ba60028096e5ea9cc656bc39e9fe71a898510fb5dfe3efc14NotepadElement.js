...
var NotepadElement = _wrapComponent('NotepadElement')(function (_Component) {
  ...
  _createClass(NotepadElement, [{
    ...
    value: function render() {
      ...
      return _react3.default.createElement(_reactNative.View, { style: [_style.styles.element, customColor] }, _react3.default.createElement(_reactNative.TouchableNativeFeedback, {
      ...
      }, _react3.default.createElement(_reactNative.View, { style: { flexDirection: 'row', alignItems: 'center', height: 45 } }, _react3.default.createElement(_reactNative.Text, { style: [_style.styles.defaultText, { flex: 1 }] }, data.header), _react3.default.createElement(_reactNative.Text, { style: { width: 80 } }, (0, _moment2.default)(+key).format('MMM Do')), _react3.default.createElement(_reactNative.Text, { style: { width: 80 } }, (0, _moment2.default)(data.lastChange ? data.lastChange : +key).format('MMM Do')))));
    }
  }]);
