...
module.exports = function (React, ReactNative) {
  ...
  var AnimatedOptionsContainer = _wrapComponent('_component')(_wrapComponent2('AnimatedOptionsContainer')(_wrapComponent3('AnimatedOptionsContainer')(React.createClass({
    displayName: 'AnimatedOptionsContainer',
