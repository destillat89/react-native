...
var TopBarEditor = _wrapComponent('TopBarEditor')(function (_Component) {
  ...
  _createClass(TopBarEditor, [{
    ...
    value: function render() {
      ...
      return _react3.default.createElement(_reactNative.View, { style: { flexDirection: 'row', alignItems: 'center', height: 50, padding: 5, backgroundColor: 'white' } }, _react3.default.createElement(_reactNative.View, { style: { flex: 7 } }, headerElement), _react3.default.createElement(_reactNative.View, { style: { flex: 3, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end' } }, editModeButton, _react3.default.createElement(_reactNativeModalDropdown2.default, {
        options: MENU_ITEMS,
