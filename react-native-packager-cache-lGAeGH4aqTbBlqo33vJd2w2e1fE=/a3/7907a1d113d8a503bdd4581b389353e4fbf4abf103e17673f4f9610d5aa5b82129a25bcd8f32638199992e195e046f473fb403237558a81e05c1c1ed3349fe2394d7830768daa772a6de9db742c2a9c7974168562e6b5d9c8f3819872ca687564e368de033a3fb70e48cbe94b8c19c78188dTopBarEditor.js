  ...
  _createClass(TopBarEditor, [{
    ...
    value: function render() {
      ...
      if (this.props.note.editMode) {
        ...
        editModeButton = _react3.default.createElement(_reactNative.View, { style: { flexDirection: 'row' } }, _react3.default.createElement(_reactNative.TouchableNativeFeedback, {
        ...
        }, _react3.default.createElement(_reactNative.View, null, _react3.default.createElement(_reactNative.Image, { source: require('../../../img/ic_save_black_36dp.png') }))), _react3.default.createElement(_ColorPicker2.default, null));
      } else {
        headerElement = _react3.default.createElement(_reactNative.Text, { style: [_style.styles.defaultText, { flex: 1 }] }, this.props.note.header);
        editModeButton = _react3.default.createElement(_reactNative.TouchableNativeFeedback, {
          onPress: this._onEditModeChange,
          background: _reactNative.TouchableNativeFeedback.SelectableBackgroundBorderless()
        }, _react3.default.createElement(_reactNative.View, null, _react3.default.createElement(_reactNative.Image, { source: require('../../../img/ic_edit_black_36dp.png') })));
      }

      return _react3.default.createElement(_reactNative.View, { style: { flexDirection: 'row', alignItems: 'center', height: 50, padding: 5, backgroundColor: _style2.colors[this.props.note.color].header } }, _react3.default.createElement(_reactNative.View, { style: { flex: 7 } }, headerElement), _react3.default.createElement(_reactNative.View, { style: { flex: 3, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end' } }, editModeButton, _react3.default.createElement(_reactNativeModalDropdown2.default, {
        options: MENU_ITEMS,
    ...
    value: function _dropdown_renderRow(rowData, rowID, highlighted) {
      return _react3.default.createElement(_reactNative.TouchableHighlight, { onPress: function onPress() {
          return alert(rowData.header);
        } }, _react3.default.createElement(_reactNative.View, { style: { width: 150, flexDirection: 'row', alignItems: 'center' } }, _react3.default.createElement(_reactNative.Image, { source: rowData.icon }), _react3.default.createElement(_reactNative.Text, { style: _style.styles.defaultText }, rowData.header)));
    }
  }]);
