...
var TabViewPagerAndroid = function (_PureComponent) {
  ...
  function TabViewPagerAndroid() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TabViewPagerAndroid.__proto__ || Object.getPrototypeOf(TabViewPagerAndroid)).call.apply(_ref, [this].concat(args))), _this), _this._isIdle = true, _this._currentIndex = 0, _this._getPageIndex = function (index) {
